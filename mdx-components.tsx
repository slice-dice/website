...
export function useMDXComponents(components: MDXComponents): MDXComponents {
    return {
        ...
        p: ({ children }: { children: React.ReactNode }) => (
            <p className="m-0 mb-6 p-5 text-justify text-[100%]">{children}</p>
        ),
        ...
        h2: ({ children }: { children: React.ReactNode }) => (
            <h2 className="m-0 mb-8 p-0 pb-4 text-center text-[1.75rem] font-bold wrap-break-word">
                <p className="bg-[#094f56] leading-7.5 text-white">{children}</p>
            </h2>
        ),
        h3: ({ children }: { children: React.ReactNode }) => (
            <h3 className="mt-4 mb-3 p-0 text-center text-[1.75rem] font-bold wrap-break-word">
                <p className="m-auto w-[80%] bg-[#CC4A49] text-[80%] leading-7.5 text-white sm:w-[30%] lg:w-[20%]">
                    {children}
                </p>
            </h3>
        ),
        ...
        img: ({ src, alt, title }: { src: string; alt: string; title: string }) => (
            <Image src={src} alt={alt} title={title} width={512} height={342} className="h-auto w-auto" />
        ),
        ...
        ShoppingTips: ({ children }: { children: React.ReactNode }) => (
            <h3 className="mt-4 mb-3 p-0 text-center text-[1.75rem] font-bold wrap-break-word">
                <p className="m-auto w-[80%] rounded-sm bg-[#094f56] p-1.25 text-[70%] leading-7.5 text-white sm:w-[40%] lg:w-[20%]">
                    {children}
                </p>
            </h3>
        ),
