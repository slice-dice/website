...
<Index><IndexItem to={`intro`}>Introduzione</IndexItem> - <IndexItem to={`punti-forti-deboli`}>Punti di forza e di debolezza</IndexItem> - <IndexItem to={`creazione`}>Creazione del personaggio</IndexItem> - <IndexItem to={`meccaniche`}>Meccaniche di gioco</IndexItem> - <IndexItem to={`distribuzione-probabilità`}>Distribuzione delle probabilità</IndexItem> - <IndexItem to={`conflitti`}>Conflitti</IndexItem> - <IndexItem to={`combattimento`}>Combattimento</IndexItem> - <IndexItem to={`danni`}>Danni</IndexItem> - <IndexItem to={`accorgimenti`}>Accorgimenti</IndexItem></Index>
